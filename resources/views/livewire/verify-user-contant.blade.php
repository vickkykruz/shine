                    ...
                    <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                        ...
                        <div class="md:col-span-5 text-right">
                            <div class="inline-flex items-end">
                                                                ...
                                                                <div class="md:w-full">
                                                                    ...
                                                                    <div class="flex items-center">
                                                                        ...
                                                                        <div class="relative w-full">
                                                                            <input type="text" id="phone-input" name="phone-input" wire:model.live="insertNewNumber" value="{{ optional($this->getUserInfo())->mobileNumber ?? '' }}" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-0 border border-gray-300 focus:ring-blue-500 focus:border-blue-500" maxlength="10" placeholder="123-456-7890">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endif
                                ...
                                @else
                                    <button wire:click="verifyPhoneNumber({{ $this->getUserInfo()->countryPhoneCode .''. $this->getUserInfo()->mobileNumber }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Verifiy your Phone Number</button>
                                @endif
                            </div>
                        </div>
